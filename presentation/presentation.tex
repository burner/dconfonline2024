...
\end{lstlisting}
	...
	\begin{frame}[fragile]{Magic}
		\begin{columns}[T]
		\begin{column}{0.52\textwidth}
		\lstinputlisting[language=D,firstnumber=1,firstline=6,lastline=15,basicstyle=\scriptsize\ttfamily]{../source/magic.d}
		\end{column}
		\begin{column}{0.48\textwidth}
		\end{column}
		\end{columns}
	...
	\begin{frame}[fragile]{More Magic}
		\lstinputlisting[language=D,firstnumber=1,firstline=32,lastline=40,basicstyle=\scriptsize\ttfamily]{../source/magic.d}
	\end{frame}
	
	\begin{frame}[fragile]{More Magic}
		\lstinputlisting[language=D,firstnumber=1,firstline=42,lastline=59,basicstyle=\scriptsize\ttfamily]{../source/magic.d}
	\end{frame}
